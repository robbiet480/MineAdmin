...
<ul>
	...
	<li class="build"><?php if($player['canBuild']){ echo "<img src=\"images/icon-checkmark.png\" />"; }else{ echo "<img src=\"images/toolbar-icon-delete.png\" />"; }?></li>
	<li class="world"><?php if($player['canModifyWorld']){ echo "<img src=\"images/icon-checkmark.png\" />"; }else{ echo "<img src=\"images/toolbar-icon-delete.png\" />"; };?></li>
