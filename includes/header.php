...
<body>
	<div id="menu-wrap">
		<h2>MCSAdmin</h2>
		<ul>
			<li class="link"><a href="logout_process.php">Logout</a></li>
            ...
            <li class="link"><a href="tools.php" <?php if ($pageid=="tools") { echo " class=\"menu_active\""; } else { echo ""; }?>>Tools</a></li>
		    <li class="link"><a href="chat.php" <?php if ($pageid=="chat") { echo " class=\"menu_active\""; } else { echo ""; }?>>Chat</a></li>
			<li class="link"><a href="news.php" <?php if ($pageid=="news") { echo " class=\"menu_active\""; } else { echo ""; }?>>News</a></li>
			<li class="link"><a href="start.php" <?php if ($pageid=="start") { echo " class=\"menu_active\""; } else { echo ""; }?>>Home</a></li>
		</ul>
		<div id="status">
